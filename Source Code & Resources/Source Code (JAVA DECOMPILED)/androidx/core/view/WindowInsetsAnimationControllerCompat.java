...
public final class WindowInsetsAnimationControllerCompat {
    ...
    public void setInsetsAndAlpha(@Nullable Insets insets, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f2, @FloatRange(from = 0.0d, to = Contrast.RATIO_MIN) float f3) {
