...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setInsetsIgnoringVisibility(int i2, @NonNull Insets insets) throws IllegalArgumentException {
    ...
    public static final class Type {
        ...
        public static int indexOf(int i2) {
            ...
            throw new IllegalArgumentException(androidx.appcompat.app.g.c(i2, "type needs to be >= FIRST and <= LAST, type="));
        }
    ...
    @NonNull
    public WindowInsetsCompat inset(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i3, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i4, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i5) {
