...
public class ActivityCompat extends ContextCompat {
    ...
    public interface PermissionCompatDelegate {
        boolean onActivityResult(@NonNull Activity activity, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, int i3, @Nullable Intent intent);

        boolean requestPermissions(@NonNull Activity activity, @NonNull String[] strArr, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2);
    }
    ...
    public static void requestPermissions(@NonNull final Activity activity, @NonNull String[] strArr, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) final int i2) {
        ...
        if (permissionCompatDelegate == null || !permissionCompatDelegate.requestPermissions(activity, strArr, i2)) {
            ...
            for (int i3 = 0; i3 < strArr.length; i3++) {
                if (TextUtils.isEmpty(strArr[i3])) {
                    throw new IllegalArgumentException(g.k(new StringBuilder("Permission request for permissions "), Arrays.toString(strArr), " must not contain null or empty values"));
                }
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.core.app.ActivityCompat.1
                    ...
                    public void run() {
                        ...
                        for (int i6 = 0; i6 < length; i6++) {
                            iArr[i6] = packageManager.checkPermission(strArr2[i6], packageName);
                        }
