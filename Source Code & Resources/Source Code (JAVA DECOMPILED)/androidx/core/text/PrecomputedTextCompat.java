...
public class PrecomputedTextCompat implements Spannable {
    ...
    @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY)
    public int getParagraphEnd(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
    ...
    @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY)
    public int getParagraphStart(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
        Preconditions.checkArgumentInRange(i2, 0, getParagraphCount(), "paraIndex");
    ...
    public static final class Params {
        ...
        public Params(@NonNull TextPaint textPaint, @NonNull TextDirectionHeuristic textDirectionHeuristic, int i2, int i3) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mWrapped = c.m(textPaint).setBreakStrategy(i2).setHyphenationFrequency(i3).setTextDirection(textDirectionHeuristic).build();
            } else {
                this.mWrapped = null;
            }
            this.mPaint = textPaint;
