...
class TypefaceCompatBaseImpl {
    ...
    private static <T> T findBestFont(T[] tArr, int i2, StyleExtractor<T> styleExtractor) {
        return (T) findBestFont(tArr, (i2 & 1) == 0 ? 400 : 700, (i2 & 2) != 0, styleExtractor);
    }
    ...
    @Nullable
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i2) throws NoSuchFieldException, SecurityException {
    ...
    @Nullable
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int i2, boolean z2) throws NoSuchFieldException, SecurityException {
