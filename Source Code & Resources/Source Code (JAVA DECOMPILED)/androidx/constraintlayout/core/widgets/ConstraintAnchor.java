    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[type2.ordinal()]) {
            ...
            case 3:
                ...
                return constraintAnchor.getOwner() instanceof Guideline ? z2 || type == Type.CENTER_X : z2;
            case 4:
            case 5:
                boolean z3 = type == Type.TOP || type == Type.BOTTOM;
                return constraintAnchor.getOwner() instanceof Guideline ? z3 || type == Type.CENTER_Y : z3;
            case 6:
