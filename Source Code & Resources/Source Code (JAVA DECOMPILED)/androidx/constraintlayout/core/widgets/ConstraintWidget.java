...
public class ConstraintWidget {
    ...
    /* JADX WARN: Removed duplicated region for block: B:308:0x0492 A[PHI: r7
  0x0492: PHI (r7v13 int) = (r7v12 int), (r7v17 int), (r7v17 int), (r7v17 int) binds: [B:301:0x0482, B:303:0x0488, B:304:0x048a, B:306:0x048e] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:33:0x008a  */
    /* JADX WARN: Removed duplicated region for block: B:350:0x0500  */
    /* JADX WARN: Removed duplicated region for block: B:352:0x0509 A[ADDED_TO_REGION] */
    ...
    */
    ...
    private void serializeSize(StringBuilder sb, String str, int i2, int i3, int i4, int i5, int i6, int i7, float f2, float f3) {
        sb.append(str);
        sb.append(" :  {\n");
        serializeAttribute(sb, "size", i2, -2.1474836E9f);
        serializeAttribute(sb, "min", i3, 0.0f);
        serializeAttribute(sb, "max", i4, 2.1474836E9f);
  ...
  0x0087: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:39:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public String toString() {
        ...
        sb.append(this.mType != null ? g.k(new StringBuilder("type: "), this.mType, " ") : "");
        sb.append(this.mDebugName != null ? g.k(new StringBuilder("id: "), this.mDebugName, " ") : "");
        sb.append("(");
        sb.append(this.mX);
        sb.append(", ");
        sb.append(this.mY);
