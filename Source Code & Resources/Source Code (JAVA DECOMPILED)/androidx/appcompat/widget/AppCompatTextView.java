...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public interface SuperCaller {
        ...
        void setLineHeight(int i2, @FloatRange(from = 0.0d) float f2);
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i2) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i2) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i2) {
    ...
    public void setLineHeight(int i2, @FloatRange(from = 0.0d) float f2) {
        if (Build.VERSION.SDK_INT >= 34) {
            getSuperCaller().setLineHeight(i2, f2);
        } else {
            TextViewCompat.setLineHeight(this, i2, f2);
        }
    }
