...
public final class MutableIntLongMap extends IntLongMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                jArr5[i8] = (jArr5[i8] & (~(255 << i9))) | (j << i9);
                int i10 = mutableIntLongMap._capacity;
                int i11 = ((iFindFirstAvailableSlot - 7) & i10) + (i10 & 7);
                int i12 = i11 >> 3;
                int i13 = (i11 & 7) << 3;
                jArr = jArr2;
                jArr5[i12] = ((~(255 << i13)) & jArr5[i12]) | (j << i13);
    ...
    public final long getOrPut(int i2, a defaultValue) {
    ...
    public final void put(int i2, long j) {
        set(i2, j);
    }
    ...
    public /* synthetic */ MutableIntLongMap(int i2, int i3, e eVar) {
        this((i3 & 1) != 0 ? 6 : i2);
    }
    ...
    public final long put(int i2, long j, long j2) {
        int iFindInsertIndex = findInsertIndex(i2);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(int i2, long j) {
        int iFindKeyIndex = findKeyIndex(i2);
