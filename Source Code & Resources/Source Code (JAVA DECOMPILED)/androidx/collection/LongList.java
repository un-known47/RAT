...
public abstract class LongList {
    ...
    public /* synthetic */ LongList(int i2, e eVar) {
        this(i2);
    }
    ...
    public final long elementAt(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
    ...
    public final long elementAtOrElse(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, l defaultValue) {
    ...
    public final <R> R foldIndexed(R r2, q operation) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            b bVar = (b) operation;
            R r3 = r2;
            r2 = (R) bVar.a(Integer.valueOf(i3), r3, Long.valueOf(jArr[i3]));
        }
        return r2;
    }
    ...
    public final <R> R foldRightIndexed(R r2, q operation) {
        ...
        while (true) {
            ...
            r2 = (R) ((b) operation).a(Integer.valueOf(i2), Long.valueOf(jArr[i2]), r2);
        }
    }
    ...
    public final long get(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
        if (i2 >= 0 && i2 < this._size) {
            return this.content[i2];
        }
        StringBuilder sbQ = g.q("Index ", i2, " must be in 0..");
    ...
    public static /* synthetic */ String joinToString$default(LongList longList, CharSequence separator, CharSequence prefix, CharSequence postfix, int i2, CharSequence charSequence, l lVar, int i3, Object obj) {
        if (obj == null) {
            if ((i3 & 1) != 0) {
                separator = ", ";
            }
            ...
            while (true) {
                if (i5 < i4) {
                    ...
                    sbN.append((CharSequence) lVar.invoke(Long.valueOf(j)));
                    i5++;
                } else {
                    sbN.append(postfix);
                    break;
