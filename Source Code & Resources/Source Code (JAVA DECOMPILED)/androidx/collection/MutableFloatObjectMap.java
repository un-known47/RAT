...
public final class MutableFloatObjectMap<V> extends FloatObjectMap<V> {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatObjectMap.findFirstAvailableSlot(i5 >>> 7);
                long j = i5 & 127;
    ...
    public final V getOrPut(float f2, a defaultValue) {
    ...
    */
    ...
    public /* synthetic */ MutableFloatObjectMap(int i2, int i3, e eVar) {
        this((i3 & 1) != 0 ? 6 : i2);
    }
