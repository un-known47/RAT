...
public final class MutableLongIntMap extends LongIntMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                int i9 = mutableLongIntMap._capacity;
    ...
    public final int getOrPut(long j, a defaultValue) {
    ...
    public final void put(long j, int i2) {
        set(j, i2);
    }
    ...
    public final void set(long j, int i2) {
    ...
    public /* synthetic */ MutableLongIntMap(int i2, int i3, e eVar) {
        this((i3 & 1) != 0 ? 6 : i2);
    }
    ...
    public final int put(long j, int i2, int i3) {
        int iFindInsertIndex = findInsertIndex(j);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(long j, int i2) {
        int iFindKeyIndex = findKeyIndex(j);
