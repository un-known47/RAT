...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    public void setCurrentItemInternal(int i2, boolean z2, boolean z3) throws Resources.NotFoundException {
    ...
    public void smoothScrollTo(int i2, int i3) throws Resources.NotFoundException {
  ...
  0x00cc: PHI (r14v6 float) = (r14v4 float), (r14v5 float), (r14v3 float) binds: [B:64:0x00f0, B:61:0x00da, B:53:0x00c1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public void setCurrentItemInternal(int i2, boolean z2, boolean z3, int i3) throws Resources.NotFoundException {
        PagerAdapter pagerAdapter = this.mAdapter;
    ...
    public void smoothScrollTo(int i2, int i3, int i4) throws Resources.NotFoundException {
        int scrollX;
        if (getChildCount() == 0) {
            setScrollingCacheEnabled(false);
            return;
        ...
        float f2 = clientWidth;
        float f3 = i8;
        float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i6) * 1.0f) / f2)) * f3) + f3;
        int iAbs = Math.abs(i4);
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i6) / ((this.mAdapter.getPageWidth(this.mCurItem) * f2) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
