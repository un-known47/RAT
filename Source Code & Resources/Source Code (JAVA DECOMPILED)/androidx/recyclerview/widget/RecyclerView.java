...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
        ...
        private void addViewInt(View view, int i2, boolean z2) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (iIndexOfChild == -1) {
                    ...
                    throw new IllegalStateException(g.d(this.mRecyclerView, sb));
                }
                if (iIndexOfChild != i2) {
        ...
        */
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                throw new IllegalArgumentException(g.d(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            }
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i2) {
            ...
            if (childViewHolderInt == null) {
                throw new IllegalArgumentException(g.d(RecyclerView.this, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
            }
            ...
            if (iFindPositionOffset < 0 || iFindPositionOffset >= RecyclerView.this.mAdapter.getItemCount()) {
                ...
                throw new IndexOutOfBoundsException(g.d(RecyclerView.this, sb));
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i2) {
            ...
            StringBuilder sbQ = g.q("invalid position ", i2, ". State item count is ");
            sbQ.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(g.d(RecyclerView.this, sbQ));
        }
        ...
        public ViewHolder getScrapOrCachedViewForId(long j, int i2, boolean z2) {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i2, boolean z2) {
            ...
            if (iIndexOfChild == -1) {
                ...
                throw new IllegalStateException(g.d(RecyclerView.this, sb));
            }
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException(g.d(RecyclerView.this, sb));
            }
            if (viewHolder.isTmpDetached()) {
                StringBuilder sb2 = new StringBuilder("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb2.append(viewHolder);
                throw new IllegalArgumentException(g.d(RecyclerView.this, sb2));
            }
            if (viewHolder.shouldIgnore()) {
                throw new IllegalArgumentException(g.d(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        ...
        public void scrapView(View view) {
            ...
            if (childViewHolderInt.isInvalid() && !childViewHolderInt.isRemoved() && !RecyclerView.this.mAdapter.hasStableIds()) {
                throw new IllegalArgumentException(g.d(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
    ...
    public class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i2, i3, i8, i9, null, 1, iArr5);
                ...
                if ((smoothScroller2 == null || !smoothScroller2.isPendingInitialRun()) && z2) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i2, i3);
                    }
                }
            }
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder sbR = g.r(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(g.d(this, sb));
                }
                StringBuilder sb2 = new StringBuilder("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                sb2.append(childViewHolderInt);
                sb2.append(" \n View Holder 2:");
                sb2.append(viewHolder);
                throw new IllegalStateException(g.d(this, sb2));
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i2) {
        ...
        sb.append(i2);
        throw new IllegalArgumentException(g.d(this, sb));
    }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str != null) {
            throw new IllegalStateException(g.d(this, g.p(str)));
        }
        throw new IllegalStateException(g.d(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            throw new IllegalStateException(g.d(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        }
        if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(g.d(this, new StringBuilder("")));
        }
    }
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(g.d(this, new StringBuilder("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            throw new IllegalArgumentException(g.d(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        }
  ...
  0x00c2: PHI (r1v45 int) = (r1v26 int), (r1v49 int) binds: [B:40:0x00ab, B:44:0x00be] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                throw new IllegalArgumentException(g.d(layoutManager.mRecyclerView, sb));
            }
