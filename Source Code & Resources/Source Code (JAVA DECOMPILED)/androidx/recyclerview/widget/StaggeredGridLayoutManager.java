...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private boolean checkSpanForGap(Span span) {
        ...
        if (span.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
            z2 = span.getLayoutParams(span.mViews.get(r0.size() - 1)).mFullSpan;
            return !z2;
        }
        return false;
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (staggeredGridLayoutManager3.mLayoutState.mInfinite || !staggeredGridLayoutManager3.mRemainingSpans.isEmpty())) {
            ...
            if (staggeredGridLayoutManager3.mOrientation == 1) {
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, i4, decoratedMeasurement, i3, minStart);
                staggeredGridLayoutManager = this;
            } else {
                staggeredGridLayoutManager3.layoutDecoratedWithMargins(next, decoratedMeasurement, i4, minStart, i3);
    ...
    */
    ...
    public void setMeasuredDimension(Rect rect, int i2, int i3) {
        ...
        if (this.mOrientation == 1) {
            ...
            iChooseSize = RecyclerView.LayoutManager.chooseSize(i2, (this.mSizePerSpan * this.mSpanCount) + paddingRight, getMinimumWidth());
        } else {
