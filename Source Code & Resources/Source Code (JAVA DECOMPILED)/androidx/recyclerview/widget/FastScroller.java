...
class FastScroller extends RecyclerView.ItemDecoration implements RecyclerView.OnItemTouchListener {
    ...
    public boolean isPointInsideVerticalThumb(float f2, float f3) {
        ...
        return f3 >= ((float) (i2 - (i3 / 2))) && f3 <= ((float) ((i3 / 2) + i2));
    }
    ...
    public void updateScrollPosition(int i2, int i3) {
        ...
        if (z3) {
            float f2 = i4;
            this.mVerticalThumbCenterY = (int) ((((f2 / 2.0f) + i3) * f2) / iComputeVerticalScrollRange);
            this.mVerticalThumbHeight = Math.min(i4, (i4 * i4) / iComputeVerticalScrollRange);
        }
        if (this.mNeedHorizontalScrollbar) {
            float f3 = i5;
            this.mHorizontalThumbCenterX = (int) ((((f3 / 2.0f) + i2) * f3) / iComputeHorizontalScrollRange);
