...
public class HctSolver {
    ...
    public static double[][] bisectToSegment(double d, double d2) {
        ...
        for (int i2 = 0; i2 < 12; i2++) {
            double[] dArrNthVertex = nthVertex(d, i2);
    ...
    public static int findResultByJ(double d, double d2, double d3) {
        ...
        while (i2 < 5) {
            ...
            double dPow3 = (Math.pow(d7, (d6 / viewingConditions.getC()) / viewingConditions.getZ()) * viewingConditions.getAw()) / viewingConditions.getNbb();
            double d10 = (((0.305d + dPow3) * 23.0d) * dPow2) / (((108.0d * dPow2) * dSin) + (((dPow2 * 11.0d) * dCos) + (23.0d * ncb)));
            double d11 = d10 * dCos;
            double d12 = d10 * dSin;
            double d13 = dPow3 * 460.0d;
            double[] dArrMatrixMultiply = MathUtils.matrixMultiply(new double[]{inverseChromaticAdaptation(((288.0d * d12) + ((451.0d * d11) + d13)) / 1403.0d), inverseChromaticAdaptation(((d13 - (891.0d * d11)) - (261.0d * d12)) / 1403.0d), inverseChromaticAdaptation(((d13 - (d11 * 220.0d)) - (d12 * 6300.0d)) / 1403.0d)}, LINRGB_FROM_SCALED_DISCOUNT);
    ...
    public static double inverseChromaticAdaptation(double d) {
        ...
        return Math.pow(Math.max(0.0d, (27.13d * dAbs) / (400.0d - dAbs)), 2.380952380952381d) * MathUtils.signum(d);
    }
