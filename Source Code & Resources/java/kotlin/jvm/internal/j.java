...
public abstract class j {
    ...
    public static final Object[] f785a = new Object[0];
    ...
    public static void i(String str) {
        s sVar = new s(androidx.appcompat.app.g.i("lateinit property ", str, " has not been initialized"));
        h(sVar, j.class.getName());
        throw sVar;
    }
