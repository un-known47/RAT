...
public final class Huffman {
    ...
    public final void decode(n source, long j, m sink) {
        j.e(source, "source");
        j.e(sink, "sink");
        Node node = root;
        int iAnd = 0;
    ...
    public final void encode(o source, m sink) {
        j.e(source, "source");
        j.e(sink, "sink");
        int iD = source.d();
        long j = 0;
        ...
        for (int i3 = 0; i3 < iD; i3++) {
            int iAnd = _UtilCommonKt.and(source.i(i3), 255);
            int i4 = CODES[iAnd];
    ...
    public final int encodedLength(o bytes) {
        j.e(bytes, "bytes");
        long j = 0;
        for (int i2 = 0; i2 < bytes.d(); i2++) {
            j += CODE_BIT_COUNTS[_UtilCommonKt.and(bytes.i(i2), 255)];
        }
        return (int) ((j + 7) >> 3);
    }
