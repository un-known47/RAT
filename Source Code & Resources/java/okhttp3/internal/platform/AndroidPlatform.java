...
public final class AndroidPlatform extends Platform implements ContextAwarePlatform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate cert) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                j.c(objInvoke, "null cannot be cast to non-null type java.security.cert.TrustAnchor");
    ...
    public List<String> getHandshakeServerNames(SSLSocket sslSocket) {
        j.e(sslSocket, "sslSocket");
        return Build.VERSION.SDK_INT < 24 ? q.f867a : super.getHandshakeServerNames(sslSocket);
    }
