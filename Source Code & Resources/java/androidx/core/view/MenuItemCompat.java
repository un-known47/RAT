...
public final class MenuItemCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c, int i2) {
        ...
        @DoNotInline
        public static MenuItem setNumericShortcut(MenuItem menuItem, char c, int i2) {
            return menuItem.setNumericShortcut(c, i2);
        }

        @DoNotInline
        public static MenuItem setShortcut(MenuItem menuItem, char c, char c2, int i2, int i3) {
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c, i2);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c, int i2) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c, i2);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c, i2);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c, char c2, int i2, int i3) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c, c2, i2, i3);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c, c2, i2, i3);
        }
    }
