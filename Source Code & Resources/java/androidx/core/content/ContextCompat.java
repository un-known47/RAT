...
public class ContextCompat {
    ...
    public static final class LegacyServiceMapHolder {
        ...
        static {
            ...
            if (Build.VERSION.SDK_INT >= 22) {
                map.put(a.c(), "telephony_subscription_service");
    ...
    public static int getColor(@NonNull Context context, @ColorRes int i2) {
        return Build.VERSION.SDK_INT >= 23 ? Api23Impl.getColor(context, i2) : context.getResources().getColor(i2);
    }
    ...
    public static String obtainAndCheckReceiverPermission(Context context) {
        ...
        throw new RuntimeException(g.i("Permission ", str, " is required by your application to receive broadcasts, please add it to your manifest"));
    }
    ...
    public static Intent registerReceiver(@NonNull Context context, @Nullable BroadcastReceiver broadcastReceiver, @NonNull IntentFilter intentFilter, @Nullable String str, @Nullable Handler handler, int i2) {
        ...
        return i6 >= 33 ? Api33Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i4) : i6 >= 26 ? Api26Impl.registerReceiver(context, broadcastReceiver, intentFilter, str, handler, i4) : ((i4 & 4) == 0 || str != null) ? context.registerReceiver(broadcastReceiver, intentFilter, str, handler) : context.registerReceiver(broadcastReceiver, intentFilter, obtainAndCheckReceiverPermission(context), handler);
    }
