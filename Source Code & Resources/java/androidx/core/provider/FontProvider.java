...
class FontProvider {
        ...
        public void close() throws Exception {
            ...
            if (contentProviderClient != 0) {
                if (contentProviderClient instanceof AutoCloseable) {
                    ...
                    androidx.core.os.a.y((ExecutorService) contentProviderClient);
                } else {
                    contentProviderClient.release();
                }
            }
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) throws PackageManager.NameNotFoundException {
        ...
        if (providerInfoResolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(g.v("No package found for authority: ", providerAuthority));
        }
        if (!providerInfoResolveContentProvider.packageName.equals(fontRequest.getProviderPackage())) {
            StringBuilder sbS = g.s("Found content provider ", providerAuthority, ", but package was not ");
            sbS.append(fontRequest.getProviderPackage());
            throw new PackageManager.NameNotFoundException(sbS.toString());
        }
    ...
    */
    public static androidx.core.provider.FontsContractCompat.FontInfo[] query(android.content.Context r16, androidx.core.provider.FontRequest r17, java.lang.String r18, android.os.CancellationSignal r19) throws java.lang.Throwable {
        /*
