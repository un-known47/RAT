...
public class ConstraintAttribute {
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        while (it.hasNext()) {
            ...
            try {
                int i2 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[constraintAttribute.mType.ordinal()];
    ...
    public void applyCustom(View view) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            switch (i2) {
                case 1:
                case 6:
                    cls.getMethod(strV, cls2).invoke(view, Integer.valueOf(this.mIntegerValue));
                    break;
                case 2:
                    cls.getMethod(strV, Boolean.TYPE).invoke(view, Boolean.valueOf(this.mBooleanValue));
                    break;
                case 3:
                    cls.getMethod(strV, CharSequence.class).invoke(view, this.mStringValue);
                    break;
                case 4:
                    cls.getMethod(strV, cls2).invoke(view, Integer.valueOf(this.mColorValue));
                    break;
                case 5:
                    ...
                    break;
                case 7:
                    cls.getMethod(strV, cls3).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
                case 8:
                    cls.getMethod(strV, cls3).invoke(view, Float.valueOf(this.mFloatValue));
                    break;
