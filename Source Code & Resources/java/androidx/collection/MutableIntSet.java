...
public final class MutableIntSet extends IntSet {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                int i7 = i6 ^ (i6 << 16);
                int iFindFirstAvailableSlot = mutableIntSet.findFirstAvailableSlot(i7 >>> 7);
                long j = i7 & 127;
                ...
                int i10 = mutableIntSet._capacity;
    ...
    */
    ...
    public /* synthetic */ MutableIntSet(int i2, int i3, e eVar) {
        this((i3 & 1) != 0 ? 6 : i2);
    }
