...
public final class MutableLongLongMap extends LongLongMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                jArr7[i7] = (jArr7[i7] & (~(255 << i8))) | (j2 << i8);
                int i9 = mutableLongLongMap._capacity;
                int i10 = ((iFindFirstAvailableSlot - 7) & i9) + (i9 & 7);
                int i11 = i10 >> 3;
                int i12 = (i10 & 7) << 3;
                jArr = jArr2;
                jArr7[i11] = (jArr7[i11] & (~(255 << i12))) | (j2 << i12);
                jArr5[iFindFirstAvailableSlot] = j;
                jArr6[iFindFirstAvailableSlot] = jArr4[i4];
            } else {
                jArr = jArr2;
            }
            i4++;
    ...
    public final long getOrPut(long j, a defaultValue) {
    ...
    public /* synthetic */ MutableLongLongMap(int i2, int i3, e eVar) {
        this((i3 & 1) != 0 ? 6 : i2);
    }
