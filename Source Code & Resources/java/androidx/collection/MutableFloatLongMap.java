...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    private final void resizeStorage(int i2) {
        ...
        while (i4 < i3) {
            if (((jArr2[i4 >> 3] >> ((i4 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatLongMap.findFirstAvailableSlot(i5 >>> 7);
                long j = i5 & 127;
                ...
                int i8 = mutableFloatLongMap._capacity;
    ...
    public final long getOrPut(float f2, a defaultValue) {
    ...
    public final void put(float f2, long j) {
        set(f2, j);
    }
    ...
    public final void set(float f2, long j) {
    ...
    public /* synthetic */ MutableFloatLongMap(int i2, int i3, e eVar) {
        this((i3 & 1) != 0 ? 6 : i2);
    }
    ...
    public final long put(float f2, long j, long j2) {
        int iFindInsertIndex = findInsertIndex(f2);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
    ...
    public final boolean remove(float f2, long j) {
        int iFindKeyIndex = findKeyIndex(f2);
