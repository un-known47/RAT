...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i3, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i4, boolean z2) {
            return charSequence;
        }
    }
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public int getEmojiEnd(@NonNull CharSequence charSequence, int i2) {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public int getEmojiStart(@NonNull CharSequence charSequence, int i2) {
    ...
    public interface GlyphChecker {
        boolean hasGlyph(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i3, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i4);
    }
    ...
    public int getEmojiMatch(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i3) {
        return process(charSequence, i2, i3, Integer.MAX_VALUE);
    }

    @Deprecated
    public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i3, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i4) {
        return process(charSequence, i2, i3, i4, 0);
    }

    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i2, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i3, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i4, int i5) {
        boolean z2;
        Preconditions.checkState(isInitialized(), "Not initialized yet");
