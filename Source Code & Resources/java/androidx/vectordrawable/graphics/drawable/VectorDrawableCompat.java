...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources resources, @DrawableRes int i2, @Nullable Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i2 = 0; i2 < pathDataNodeArr.length; i2++) {
                ...
                sbP.append(pathDataNodeArr[i2].mType);
                sbP.append(":");
                string = sbP.toString();
                for (float f2 : pathDataNodeArr[i2].mParams) {
                    StringBuilder sbP2 = g.p(string);
                    sbP2.append(f2);
                    sbP2.append(",");
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i2, int i3, ColorFilter colorFilter) {
            ...
            while (i4 < vGroup2.mChildren.size()) {
                ...
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i2, i3, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i2, i3, colorFilter);
                }
                i4++;
                vGroup2 = vGroup;
            }
