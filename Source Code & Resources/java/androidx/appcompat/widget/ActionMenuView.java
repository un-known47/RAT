    ...
    */
    ...
    private void onMeasureExactFormat(int i2, int i3) {
        ...
        while (i15 > 0 && i10 > 0) {
            ...
            while (i25 < childCount) {
                ...
                if ((j3 & j4) == 0) {
                    ...
                    if (z8 && layoutParams3.preventEdgeOffset && i10 == 1) {
                        int i27 = this.mGeneratedItemPadding;
                        i6 = i25;
                        childAt2.setPadding(i27 + i4, 0, i27, 0);
                    } else {
                        i6 = i25;
                    }
        ...
        if (i10 > 0 && j2 != 0 && (i10 < i14 - 1 || z9 || iMax2 > 1)) {
            ...
            int i29 = fBitCount > 0.0f ? (int) ((i10 * i4) / fBitCount) : 0;
        ...
        setMeasuredDimension(i8, mode != 1073741824 ? i5 : i18);
    }
