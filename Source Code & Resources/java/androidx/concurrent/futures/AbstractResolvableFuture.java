...
public abstract class AbstractResolvableFuture<V> implements a {
    ...
    public final V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException {
        ...
        if (nanos + SPIN_THRESHOLD_NANOS < 0) {
            ...
            strH = g.h(strH2, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(g.h(strH, " but future completed as timeout expired"));
        }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return g.k(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
